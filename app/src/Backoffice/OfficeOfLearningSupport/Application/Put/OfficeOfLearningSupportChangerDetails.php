<?php
	...
	use App\Backoffice\OfficeOfLearningSupport\Domain\OfficeOfLearningSupportNameIsAvailableSpecification;
	use App\Backoffice\OfficeOfLearningSupport\Domain\OfficeOfLearningSupportRepository;
	use App\Backoffice\OfficeOfLearningSupport\Domain\ValueObject\OfficeOfLearningSupportBiography;
  ...
  final class OfficeOfLearningSupportChangerDetails
	{
		...
		private OfficeOfLearningSupportNameIsAvailableSpecification $addressIsAvailableSpecification;
  
    /**
     * @var \App\Backoffice\OfficeOfLearningSupportInDistrict\Application\Get\Single\OfficeOfLearningSupportInDistrictFinder
     */
    private $officeOfLearningSupportInDistrictFinder;

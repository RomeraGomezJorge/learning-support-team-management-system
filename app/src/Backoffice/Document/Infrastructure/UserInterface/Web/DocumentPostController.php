...
class DocumentPostController extends WebController
{
    ...
    private function create(Request $request, DocumentCreator $creator, GetAttachmentsInRequestAndUploadFiles $getAttachmentsInRequestAndUploadFiles): RedirectResponse
    {

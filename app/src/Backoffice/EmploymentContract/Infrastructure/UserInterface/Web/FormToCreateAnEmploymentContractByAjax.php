<?php
	...
	final class FormToCreateAnEmploymentContractByAjax extends WebController implements RenderFormInterface
	{
		...
		{
			return $this->render('backoffice/employmentContract/addEmploymentContractByModal.html.twig', [
